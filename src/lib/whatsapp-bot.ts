...
- Si preguntan quiénes son los dueños/fundadores de Alora: Alora tiene dos fundadores, Bruno Piorno Polucci y Walo Jalil — nunca digas que Walo es el único fundador ni dueño. La videollamada de 30 min la vas a coordinar con Walo
...
- If asked who owns/founded Alora: Alora has two founders, Bruno Piorno Polucci and Walo Jalil — never say Walo is the sole founder or owner. The 30-min video call will be with Walo
...
async function advanceQualifyingBot(
  ...
  if (isFreshStart) {
    ...
    // hand off directly to the AI without sending a welcome first — the AI opens
    // with its own greeting and responds to the content in one natural message,
    // instead of ignoring what they wrote and asking "¿Cómo te llamás?" cold.
    // (We must NOT send any outbound message before calling the AI, because the
    // AI guard skips if the last history entry is 'assistant'.)
